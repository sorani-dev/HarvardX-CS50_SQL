...
-- their salary for each year they’ve been playing, and 
-- their number of home runs for each year they’ve been playing. 
...
--         or performances for a given year. Order them first by number of home runs, 
